# Generated by Django 5.0.7 on 2024-08-27 07:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('answers', models.ManyToManyField(related_name='questions', to='pdpa.mstpdpaanswer')),
                ('sub_category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pdpa.mstpdpasubcategory')),
            ],
        ),
        migrations.CreateModel(
            name='TnxPdpaResult',
